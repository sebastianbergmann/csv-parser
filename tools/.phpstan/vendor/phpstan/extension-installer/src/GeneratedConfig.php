...
final class GeneratedConfig
{
  ...
  array (
    'install_path' => '/usr/local/src/csv-parser/tools/.phpstan/vendor/ergebnis/phpstan-rules',
  ...
  array (
    'install_path' => '/usr/local/src/csv-parser/tools/.phpstan/vendor/phpstan/phpstan-strict-rules',
  ...
  array (
    'install_path' => '/usr/local/src/csv-parser/tools/.phpstan/vendor/tomasvotruba/type-coverage',
